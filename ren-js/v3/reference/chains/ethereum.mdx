...
The Kovan Ethereum testnet is in the process of being shut down, and any testnet integration that has been deployed on Kovan needs to be migrated to Görli. After redeploying any required contracts on Görli, you can update RenJS to point to Görli by:
