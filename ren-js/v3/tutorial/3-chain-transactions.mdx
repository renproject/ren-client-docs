...
```tsx reference title=""
https://github.com/renproject/ren-js-v3-tutorial/blob/master/tutorial-ui/src/ChainTx.tsx#L27-L46
```
...
```tsx reference title=""
https://github.com/renproject/ren-js-v3-tutorial/blob/master/tutorial-ui/src/ChainTx.tsx#L50-L61
```

#### 2. `"confirming"`

```tsx reference title=""
https://github.com/renproject/ren-js-v3-tutorial/blob/master/tutorial-ui/src/ChainTx.tsx#L63-L76
```

#### 3. `"done"`

```tsx reference title=""
https://github.com/renproject/ren-js-v3-tutorial/blob/master/tutorial-ui/src/ChainTx.tsx#L78-L83
```

#### 4. `"reverted"`

```tsx reference title=""
https://github.com/renproject/ren-js-v3-tutorial/blob/master/tutorial-ui/src/ChainTx.tsx#L85-L88
```
