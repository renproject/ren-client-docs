...
```tsx reference title=""
https://github.com/renproject/ren-js-v3-tutorial/blob/master/tutorial-ui/src/GatewayTx.tsx#L13-L16
```
...
```tsx reference title=""
https://github.com/renproject/ren-js-v3-tutorial/blob/master/tutorial-ui/src/GatewayTx.tsx#L20-L23
```
...
```tsx reference title=""
https://github.com/renproject/ren-js-v3-tutorial/blob/master/tutorial-ui/src/GatewayTx.tsx#L25-L28
```
...
```tsx reference title=""
https://github.com/renproject/ren-js-v3-tutorial/blob/master/tutorial-ui/src/GatewayTx.tsx#L29-L37
```

3. `gatewayTx.out`

```tsx reference title=""
https://github.com/renproject/ren-js-v3-tutorial/blob/master/tutorial-ui/src/GatewayTx.tsx#L38-L46
```
