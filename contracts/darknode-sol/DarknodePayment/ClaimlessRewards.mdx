...
contract. Its two main improvements are:
...
### **`constructor`** _`(contract DarknodeRegistryLogicV1 _darknodeRegistry, contract DarknodePaymentStore _darknodePaymentStore, address _communityFund, uint256 _communityFundNumerator)`_ (public)
