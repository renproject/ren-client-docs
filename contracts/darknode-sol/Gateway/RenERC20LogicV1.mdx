...
### **`initialize`** *`(uint256 _chainId, address _nextOwner, uint256 _initialRate, string _version, string _name, string _symbol, uint8 _decimals)`* (public)
...
### **`burn`** *`(address _from, uint256 _amount)`* (public)
